    ...
    >
      <div className="px-6 md:px-12 lg:px-24">
        ...
        <div className="flex flex-col items-center">
          <motion.div className="flex flex-col gap-3 w-full max-w-3xl" variants={staggerContainerFast}>
            {faqs.map((faq, index) => {
              ...
              return (
                ...
                >
                  <button
                    ...
                    className="flex items-center justify-between w-full text-left p-5 md:p-6 cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
                  >
                  ...
                  >
                    <div className="flex flex-col md:flex-row gap-5 p-5 md:p-6 pt-0">
                      ...
                      <div className="flex flex-col gap-3 flex-1">
                        <p className="font-body text-body m-0 !text-primary-foreground">
                          {faq.answer1}
                        </p>
                        <p className="font-body text-body m-0 !text-primary-foreground">
                          {faq.answer2}
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-8 rounded-3xl">
            <div className="flex flex-col gap-3 text-center md:text-left">
              <p className="font-body text-body m-0 max-w-lg text-muted-foreground">
We&apos;re here to help! Whether you&apos;re curious about house rent,
            ...
            <motion.a
              ...
              className="inline-flex items-center justify-center gap-2 py-3 px-6 text-body !text-primary-foreground rounded-xl bg-primary transition-all duration-200 hover:opacity-90 shrink-0 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
            >
              <svg
                viewBox="0 0 256 256"
